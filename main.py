...
__CHANNEL_USERNAME__ = "https://t.me/cpmazraeldevs"
__GROUP_USERNAME__   = "@AzraelDevs"
...
def banner(console):
    ...
    brand_name = figlet_format('Azrael', font='starwars')
    colors = [
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{03}: Rank King                         8.000'))
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{08}: Delete account                   GRATIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{09}: Register account                  GRATIS'))
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{13}: Unlock car sirens      3.500'))
            print(Colorate.Horizontal(Colors.rainbow, '{14}: Unlock w16 engine             4.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{15}: Unlock all speakers     3.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{16}: Unlock without damage             3.000'))
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{20}: Unlocking tires               4.000'))
